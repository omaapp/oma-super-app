...
abstract class AppLocalizations {
  ...
  /// No description provided for @tripHistoryDesc.
  ///
  /// In en, this message translates to:
  /// **'View all previous trips'**
  String get tripHistoryDesc;
  ...
  /// No description provided for @savedAddressesDesc.
  ///
  /// In en, this message translates to:
  /// **'Home, Work and more'**
  String get savedAddressesDesc;
  ...
  ///
  /// In en, this message translates to:
  /// **'All your account notifications'**
